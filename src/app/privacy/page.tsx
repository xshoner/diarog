      ...
      <section className="space-y-5">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><b>Android Companion(선택)</b>: 지정한 통화녹음 폴더의 음성을 기기 내 Vosk 모델로 전사합니다. 원본 음성은 업로드하지 않으며, 전사문은 diarog 서버와 Letsur AI로 보내 요약·사람·주제·약속·할 일을 추출합니다. diarog 데이터베이스에는 전사문 대신 추출 결과와 발생 시각을 저장합니다.</li>
            <li><b>Health Connect(선택)</b>: 허용한 일별 걸음 수 합계를 읽어 개인 일기에 사용합니다. 광고에 사용하거나 판매하지 않습니다.</li>
            <li><b>이동 기록(선택)</b>: 앱에서 수집을 켠 동안 알림을 표시하며 위치·시각·정확도를 수집합니다. 앱 또는 알림에서 중지할 수 있습니다. 서버에 전송하지 못한 기록은 기기에 보관했다가 재시도합니다.</li>
